...
namespace QLTKB
{
    class ConnectDB
    {
        ...
        public ConnectDB()
        {
            SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-DVL97US\SQLEXPRESS; Initial Catalog=QLTKB; Integrated Security=True");
        }

        public SqlConnection getcon()
        {
            return new SqlConnection(@"Data Source=DESKTOP-DVL97US\SQLEXPRESS; Initial Catalog=QLTKB; Integrated Security=True");
        }
